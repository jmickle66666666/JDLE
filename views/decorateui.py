...
class DecorateUI(Frame):
    ...
    def build_actors(self):
        ...
        # event handling
        def on_select(event):
            cur_item_id = self.actor_list.selection()[0]
    ...
    def build_actor_view(self,actor):
        ...
        def state_select(event):
            cur_item_id = self.actor_states.selection()[0]
...
if __name__ == '__main__':
    ...
    dec = decorate.Decorate(dcode)

    app = Tk(None)
    decui = DecorateUI(app,dec,wad)
    decui.grid(sticky="news")
